...
#include <utility>
#include <cstddef>
#include <unordered_map>              // check if i can include this or not
#include <thread>
#include <iterator>
#include <algorithm>
...
{   
    ...
    public:
        std::unordered_map<power, coeff> poly_map;
        /**
        ...
        //polynomial multiply(const std::pair<power, coeff> &multiply_by) const;
        // void multiply(const std::pair<power, coeff> &multiply_by, polynomial& return_to_operator);
         ...
         * 2. polynomial + int
         * 3. int + polynomial  ->  is a friend function
         * 
...
polynomial operator+(int x, const polynomial& poly);
polynomial operator*(int x, const polynomial& poly);
//void multiply(const std::pair<power, coeff> &multiply_by, polynomial &return_to_operator);
